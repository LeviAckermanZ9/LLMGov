...
def test_cache_miss_writes_to_redis(mock_redis, mock_litellm, mock_embedding):
...
def test_cache_hit_returns_immediately(mock_redis, mock_litellm, mock_embedding):
    import json
